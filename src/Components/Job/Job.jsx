...
const Job = ({ job }) => {
    const {id, logo, job_title, company_name, remote_or_onsite, location, job_type, salary } = job; return (
        <div>
            <div className="card card-compact bg-base-100  shadow-xl">
                ...
                <div className="card-body">
                    ...
                    <div className=" text-[#7E90FE]">
                        <button className="py-2 px-5 border rounded-s font-extrabold mr-4 border-[#7E90FE]">{remote_or_onsite}</button>
                        <button className="py-2 px-5 border rounded-s font-extrabold mr-4 border-[#7E90FE]">{job_type}</button>
                    </div>
                   ...
                   <Link to={`/job/${id}`}> <button className="btn py-3 px-5 border-4 rounded font-extrabold text-white bg-[#9873FF]">View Details</button></Link>
                </div>
            </div>
        </div>
    );
